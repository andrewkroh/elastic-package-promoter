...
0369e61d1e4b35978c3ef5d0ad23a58493cfc939 from 2022-02-11 18:21:00 +0000 UTC.
...
- Docker Metrics - 1.2.0
    - Requires ^7.14.0 || ^8.0.0
    - Changes since 1.0.0
        - 1.2.0
            - enhancement: Release package for 8.0.0 [PR](http://github.com/elastic/integrations/pull/)

        - 1.1.1
            - enhancement: Uniform with guidelines [PR](https://github.com/elastic/integrations/pull/2012
              )

        - 1.1.0
            - enhancement: Update to ECS 1.12.0 [PR](https://github.com/elastic/integrations/pull/1691)
...
To promote these packages use:

`elastic-package promote -d=snapshot-production -n -p "apache-1.3.4,aws-1.11.4,aws_logs-0.1.0,cassandra-1.2.0,cockroachdb-0.2.1,docker-1.2.0,etcd-0.1.1,haproxy-1.1.0,iis-0.8.2,kafka-1.2.0,kubernetes-1.16.0,mysql-1.3.0,nats-1.3.0,nginx-1.3.0,nginx_ingress_controller-1.3.0,prometheus-0.9.0,rabbitmq-1.3.0,redis-1.3.0,stan-1.3.0,system-1.10.0,traefik-1.3.0,windows-1.10.0,zookeeper-1.3.0"`
